...
class TestStores:
    ...
    def test_filter_and_click_random_store(self, stores_page):
        ...
        logger.info("Successfully filtered stores by letter 'S'")
        ...
        logger.info("Found {} stores after filtering".format(store_count))
        ...
        logger.info("Generated random index: {} (valid range: 1-{})".format(random_index, store_count))
        ...
        logger.info("Successfully clicked on store at index: {}".format(random_index))
